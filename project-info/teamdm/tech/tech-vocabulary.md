...
DM: last sentence is correct - I removed it because it's not anything you need to know, vocab should concise, read quickly(ok)
...
DM: going forward, use google search for vocab definitions, preferring the most authoritative sites, like MDN. AI is too often making things up, not blatantly wrong, but sometimes using the wrong terminology. Continue to use AI for code examples, but always test them to be sure they work.(ok)