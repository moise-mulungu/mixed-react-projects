...
/* CURRENT STATUS and NEXT STEPS (update this section before each commit of the file)
   ...
   CURRENT STATUS: this code works, and passes all the test cases. 
    NEXT STEPS: the remaining steps are your code review and approval. thanks!
   DM: I approved it, restored the code in #14 and moved it out of the 'currently working 'directory.(ok)
   DM: done!
*/
