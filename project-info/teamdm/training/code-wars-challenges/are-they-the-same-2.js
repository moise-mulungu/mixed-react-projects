...
function comp(numbers, squaredNumbers) {
  ...
  // DM: todoMM: whenever you get stuck with a hard reduce issue, do a global regexp search on the howtojs lines. Search on "howtojs.*reduce" and look at a few examples to refresh your memory. Try it now. Also, you can global regexp search on ".reduce(" to see all places you have previously used reduce(ok).
