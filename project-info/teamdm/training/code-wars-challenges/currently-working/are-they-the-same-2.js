...
function comp(numbers, squaredNumbers) {
  ...
  if (
    ...
    // DM: todoMM: based on the diffs I can't tell if if works, or what issues you had. Write the current status of this exercise so that I can know without having to run it myself.
  }
...
comp([], null) // false
// DM: todoMM: make sure your solution works with this new test on the line below
comp(null, []) // false
