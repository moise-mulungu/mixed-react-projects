// DM: ignore this file for now, I'll finish what I want to do with it tomorrow
...
* the lastFibonacciNumber + theSecondToLastFibonacciNumber
...
// this one makes it more clear which is the fibonacciNumber and which is the fibonacciSequenceNumber
function fibonacci(n, cache = { 0: 0, 1: 1 }) {
  if (cache[n] !== undefined) return cache[n]
  const answer = fibonacci(n - 1, cache) + fibonacci(n - 2, cache)
  cache[n] = answer
  return answer
}
