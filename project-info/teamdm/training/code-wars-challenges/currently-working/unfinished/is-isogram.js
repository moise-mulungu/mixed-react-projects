...
//(done) DM: hey Moise, I spend way too much time figuring out where you are at in these files. It would save time if you update the status each time you commit, so that I can more quickly know what to do and how to help. you didn't update the status before you commit. do all the tests pass? what is my next step?
