...
Moise, you're not following instructions. It's a problem. You can't do that on a job. Yesterday I wrote above, "note: don't do any major changes to your code ... You just need to debug it and make small change ...". Yet, you commented it out, saying, maybe I'll do it later, then you did exactly what I said not to do: "major changes", a new approach. A new approach doesn't complete the task, which was to debug your existing code. 

You can't just give up. In a coding interview, you can't just give up. The interviewers won't let you. 

I know you can do it. If you're stuck, tell me where you're stuck. Ask me a good question. Put the console.logs where I suggest. Take the hints like the one I gave you below. If you're still stuck, then spend some time figuring out exactly on which line things go wrong. Add more console.logs until you know EXACTLY what is happening each line, each iteration of the loop. You might also review the challenge and walk through one of the tests to know exactly what should happen, so you can tell where it goes wrong. If none of that works, you can tell me, "I think I need help with this in person on Zoom". That's fine, but the first thing I'll ask is what you tried so far. I'll ask, "where does the code fail". I should see a lot of console.logs and it should be really clear that you really tried to figure it out by doing all the things in this paragraph. You should be able to explain the steps and logic the program SHOULD do. 

I reverted all your changes in your last commit (saving your new solution to word-mesh-3.js). I've mentioned a lot of times that the purpose of the code challenges is to practice techniques, not to get solutions. This code has lessons for you. Therefore, I want you to figure out how to debug the code. You need to learn some things about "control flow" (see your entry in the programming vocab file). "Control flow" describes what the bug is about. Understanding "control flow" will help a lot, also with recursion.
