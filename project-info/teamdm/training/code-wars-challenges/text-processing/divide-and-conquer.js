// DM: Moise, I'm going to stop putting todoMM in codewars files. literally every comment I make in codewars files imply an instruction to do something. i'm getting tired of tyhping it:)
...
function divCon(x) {
  ...
  */
  ...
  // DM: small name change; I added some redundancy in order to make it clear that some of the array elems are strings and that is OK
