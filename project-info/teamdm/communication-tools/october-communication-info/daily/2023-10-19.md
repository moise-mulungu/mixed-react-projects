...
//(done. i am sorry, i read the two articles but i did n't pay attention to the "Add these useful hooks to the repo" instruction. OK, no worries, just remember that "attention to detail" thing - over time you'll train yourself to always carefully pay attention to detail. Programming skills require attention to fine detail, but if you are a big picture person, this will help you later in your career.) DM: todoMM: if you don't do one of the tasks, at least make some mention of it. It's fine if you have a reason to not do part of a task, but let me know that reason. My instructions say to add the hooks to the repo.
