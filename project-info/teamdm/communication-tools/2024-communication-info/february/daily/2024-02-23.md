MM: i'll add the weekly hours on Sunday to totalize remaining hours
...
DM: todoMM: QQ: what is the logic/criteria for isActive? How does a user become active? How does that status get sent to the DB? How does a user become inactive? How does that status get sent to the DB? 
