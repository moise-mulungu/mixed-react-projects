...
* previous PTO hours accrued: 0 hrs(MM: i got this answer: PTO hours accrued refers to the amount of paid time off that an employee has earned but not yet used. This could include vacation time, sick leave, or personal days.)
* PTO hours used this week: 13.5 hrs (40 - 26.5 = 13.5)
* PTO hours accrued this week: 3.5 hrs
* current PTO hours accrued: -10.5 hrs(MM: what would be the difference between previous and current PTO hours accrued in the context that i am working for the approximate of 40hrs/week?)
* 
# daily - 7.75h
