...
//(done) DM: todoMM: the func name doesn't match the filename. Good that you created a directory for this. In this case, in the context of the utils/array directory, the dir name and func name can be just shuffle(), and this filename index.js.
...
// DM: we consistently use "es modules" in this repo, not "commonjs"
