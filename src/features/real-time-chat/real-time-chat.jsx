...
import {
  ...
  */
  ...
  get as getDatabaseValue, //(done) DM: todoMM: give this a more descriptive alias because this is a very large file
} from 'firebase/database'
                        ...
                        return (
                          ...
                          >
                            <div className="flex items-center">
                              {/*MM: this console.log  outputs the formatted display name of the connected user as expected, but what is strange is how it doesn't display the formatted display name in the browser. DM: this shows a username for me only, the current user: Dmdmdm- but is undefined for all other users. MM; but before displaying other usernames, i would want to first display for the "me" user, then others*/}
                              {console.log(
