...
Effort 
  ...
  * DM: good point, but only show the effort to do the thing. You can list dependencies separately. "displaying the list of connected users" is something you have to do anyway, this is just about adding a "..." after you already have that info in the app.
...
Effort 2 - what type of communication to use for users? do you mean adding text to each feature of the app? Is there any hidden features? The ctrl-Enter feature is "hidden" if you dont explicitly tall the user in the UI.
