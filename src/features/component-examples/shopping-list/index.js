        ...
        <ol>
          {items.map(({ id, label }) => (
            <li
              ...
              style={{ width: 'fit-content' }} // DM: don't think this is possible with tailwindcss. Sometimes you have to just use a CSS style, but tailwindcss usually has everything you need.
            >
              {label}
              <button
                ...
                // DM: good job on this styling in these last 2 components in your examples page.
                // DM: don't forget to break up this page into smaller groups of because it is getting too big and slow.
