...
function Avatar({ src, alt }) {
  return (
    ...
    // DM: todoMM: now that you have the structure set up, practice by making another version of Avatar in a different directory, and look through TWui for something similar, then implement the styles from TWui
