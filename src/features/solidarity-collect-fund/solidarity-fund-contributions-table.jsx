...
//(done) DM: todoMM: you downgraded "@heroicons/react" to an older version  "^1.0.6". Never go backwards. So update to the pervious version: 2.0.14 and make that work or choose another icon. You can also go to the heroicons wrbsite and copy the React code for that icon and use it directly in your code.
