...
//(done) DM: todoMM: this file is empty now
...
// BUt, you need the name fo your site in the title tag, and this , the top level, is where it should be. I'm not sure why the compiler didn't throw an error when appTitle was nto exported from the constants file ...
