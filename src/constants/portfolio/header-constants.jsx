// DM: todoMM: please remove "constants" from all directory and file names in the constants/portfolio directory tree. Sorry, seems pedantic, but it is a really good rule to follow. the DRY principle: don't repeat yourself.
